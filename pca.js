...
var PC3;
const colors = {};
document.getElementById("Col1").value = 2;
document.getElementById("Col2").value = 31;
...
function processData() {
  ...
  const Col1 = parseInt(document.getElementById("Col1").value);
  ...
  if (ColCat > -1) {
    labels = rows.map((row) => row.split(",").slice(ColCat)[0].trim());
  } else {
    labels = [];
